...
describe('web service', function () {
  ...
  describe('multiple services', function () {
    ...
    beforeEach(function () {
      ...
      instance.inlineService.mock(fixtures.integration.registerSuccessfulMockRequest.json.json);
      instance.inlineService.makeRequest(
        obj.clone(fixtures.integration.registerSuccessfulMockRequest.json.json.request));
      instance2.inlineService.mock(fixtures.integration.registerSuccessfulMockPOSTRequest.json.json);
    });
