...
describe('register api module', function () {
  ...
  var registerResponse, registerAPI, entryRequest, entryResponse, request, body,
    entryDependencies, config, entry, entries;
  ...
  beforeEach(function () {
    ...
    entry = {
      ...
      parsedQueryData: jasmine.createSpy('parsedQueryData').and.callFake(function (parsedUrl) {
  ...
  describe('successfully register a mock api with a body in the correct format', function () {
    ...
    it('should call entry.addEntry',
      function () {
        ...
        expect(entry.addEntry).toHaveBeenCalledOnceWith(entryRequest, entryResponse, body.expires, [{
    ...
    it('should include dependency response if specified', function () {
      ...
      expect(entry.addEntry).toHaveBeenCalledWith(entryRequest, entryResponse, body.expires, [{
        request: entryDependencies[0],
        response: {
